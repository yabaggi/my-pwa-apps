...
self.addEventListener('install', event => {
    ...
    event.waitUntil(
        caches.open(CACHE_NAME)
            .then(cache => {
                console.log('[Service Worker] Caching app shell and all files for Video Player App');
                return cache.addAll(urlsToCache);
            })
            .then(() => {
                console.log('[Service Worker] All files cached successfully for Video Player App');
            ...
            .catch(error => {
                console.error('[Service Worker] Caching failed for Video Player App:', error);
            })
    );
});

self.addEventListener('activate', event => {
    console.log('[Service Worker] Activating for Video Player App...');
    event.waitUntil(
