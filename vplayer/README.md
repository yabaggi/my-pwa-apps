...
**App Name:** Video Player App  
**Short Name:** Video Player  
**App ID:** vplayer-id  
**Folder Name:** vplayer  
**Start URL:** /vplayer/  
**Scope:** /vplayer/  
...
```bash
cd /path/to/pwaApps
unzip vplayer-pwa.zip -d vplayer
```
...
```
✓ Service Worker registered: http://localhost:8000/vplayer/
...
```
GET /vplayer/ HTTP/1.1" 200 -
GET /vplayer/manifest.json HTTP/1.1" 200 -
GET /vplayer/sw.js HTTP/1.1" 200 -
```
...
# Extract
unzip ~/storage/downloads/vplayer-pwa.zip -d vplayer
...
2. Access with trailing slash: `http://localhost:8000/vplayer/`
...
Upload the entire `vplayer` folder to:
...
- **Total Package Size:** ~153.06 KB (estimated)
...
**Generated on:** 29/12/2025, 12:49:58  
**PWA Converter Version:** 2.0.1 (Folder Upload Edition)  
**Original Folder:** vplayer  
**Sanitized Name:** vplayer  
**Files Included:** 4  
**Access URL:** http://localhost:8000/vplayer/  
