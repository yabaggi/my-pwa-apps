...
const CACHE_NAME = 'prom-v4';
const OFFLINE_URL = '/prom/offline.html';

const urlsToCache = [
  "/my-pwa-apps/prom2/favicon.ico",
  "/my-pwa-apps/prom2/icons/icon-72x72.png", 
  "/my-pwa-apps/prom2/icons/icon-96x96.png", 
  "/my-pwa-apps/prom2/icons/icon-128x128.png", 
  "/my-pwa-apps/prom2/icons/icon-144x144.png", 
  "/my-pwa-apps/prom2/icons/icon-152x152.png", 
  "/my-pwa-apps/prom2/icons/icon-192x192.png", 
  "/my-pwa-apps/prom2/icons/icon-384x384.png", 
  "/my-pwa-apps/prom2/icons/icon-512x512.png",
  "/prom/",
  "/prom/index.html",
  "/prom/manifest.json",
