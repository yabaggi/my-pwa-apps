/**
 * Service Worker for Termux Dev Academy — Build Apps from Your Phone
...
self.addEventListener('install', event => {
    console.log('[Service Worker] Installing for Termux Dev Academy — Build Apps from Your Phone...');
    event.waitUntil(
        caches.open(CACHE_NAME)
            .then(cache => {
                console.log('[Service Worker] Caching app shell and all files for Termux Dev Academy — Build Apps from Your Phone');
                return cache.addAll(urlsToCache);
            })
            .then(() => {
                console.log('[Service Worker] All files cached successfully for Termux Dev Academy — Build Apps from Your Phone');
            ...
            .catch(error => {
                console.error('[Service Worker] Caching failed for Termux Dev Academy — Build Apps from Your Phone:', error);
            })
    );
});

self.addEventListener('activate', event => {
    console.log('[Service Worker] Activating for Termux Dev Academy — Build Apps from Your Phone...');
