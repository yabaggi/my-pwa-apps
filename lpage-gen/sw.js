/**
 * Service Worker for Landing Page Generator
...
self.addEventListener('install', event => {
    console.log('[Service Worker] Installing for Landing Page Generator...');
    event.waitUntil(
        caches.open(CACHE_NAME)
            .then(cache => {
                console.log('[Service Worker] Caching app shell and all files for Landing Page Generator');
                return cache.addAll(urlsToCache);
            })
            .then(() => {
                console.log('[Service Worker] All files cached successfully for Landing Page Generator');
            ...
            .catch(error => {
                console.error('[Service Worker] Caching failed for Landing Page Generator:', error);
            })
    );
});

self.addEventListener('activate', event => {
    console.log('[Service Worker] Activating for Landing Page Generator...');
    event.waitUntil(
...
console.log('[Service Worker] Loaded successfully for Landing Page Generator');
