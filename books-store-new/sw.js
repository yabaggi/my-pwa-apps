/**
 * Service Worker for Book Finder
...
self.addEventListener('install', event => {
    console.log('[Service Worker] Installing for Book Finder...');
...
console.log('[Service Worker] Loaded successfully for Book Finder');
console.log('[Service Worker] Scope: /books-store-new/');
