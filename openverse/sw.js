/**
 * Service Worker for Simple Media Browser
...
self.addEventListener('install', event => {
    console.log('[Service Worker] Installing for Simple Media Browser...');
...
console.log('[Service Worker] Loaded successfully for Simple Media Browser');
console.log('[Service Worker] Scope: /openverse/');
